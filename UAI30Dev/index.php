...
<!DOCTYPE html>
<html lang="en">
<script>function tokenJSError(){document.querySelector('.middle').innerHTML= "<h1><br><br><br><br>Token Don't Exist <br><a href=\"url\"> Buyt Token</a> </h1>";}</script>
...
<body>
  ...
  <header class="header">
    <h1 class="header__title"><center>Universal AI 3.0 Web App - UAI Token # <?echo"$_SESSION[token]";?></center></h1>
  ...
  <main class="main"><center>
	...
	<div class="bottom" ><br><br><?include('getUserMedia.php'); ?></div>
